...
const (
	CheckStatusEnumSuccess CheckStatusEnum = "success"
	CheckStatusEnumFailed  CheckStatusEnum = "failed"
	CheckStatusEnumWarning CheckStatusEnum = "warning"
)

func (e *CheckStatusEnum) Scan(src interface{}) error {
	switch s := src.(type) {
	case []byte:
		*e = CheckStatusEnum(s)
	case string:
		*e = CheckStatusEnum(s)
	default:
		return fmt.Errorf("unsupported scan type for CheckStatusEnum: %T", src)
	}
	return nil
}

type NullCheckStatusEnum struct {
	CheckStatusEnum CheckStatusEnum
	Valid           bool // Valid is true if CheckStatusEnum is not NULL
}

// Scan implements the Scanner interface.
func (ns *NullCheckStatusEnum) Scan(value interface{}) error {
	if value == nil {
		ns.CheckStatusEnum, ns.Valid = "", false
		return nil
	}
	ns.Valid = true
	return ns.CheckStatusEnum.Scan(value)
}

// Value implements the driver Valuer interface.
func (ns NullCheckStatusEnum) Value() (driver.Value, error) {
	if !ns.Valid {
		return nil, nil
	}
	return string(ns.CheckStatusEnum), nil
}
